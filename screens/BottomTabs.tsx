...
export default function BottomTabs() {
  return (
    ...
    // 2. Ensure any internal title is empty
    tabBarLabel: "",
        tabBarStyle: {
          position: "absolute",
          height: 40,
        ...
        tabBarIcon: ({ color, focused }) => {
          switch (route.name) {
            ...
            case "Therapy":
              return <Ionicons name={focused ? "fitness" : "fitness-outline"} size={22} color={color} />;
            case "Peace":
              return <Ionicons name={focused ? "leaf" : "leaf-outline"} size={22} color={color} />;
            case "Meditation":
              return <Ionicons name={focused ? "moon" : "moon-outline"} size={22} color={color} />;
            case "Settings":
